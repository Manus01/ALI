...
export default function BrandMonitoringSection({ brandName }) {
    ...
    const [activeTab, setActiveTab] = useState("main"); // 'main' or specific keyword
    ...
    return (
        <>
            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
                {/* Header with Summary */}
                {/* Header with Summary and Tabs */}
                <div className="border-b border-slate-100">
                    {/* Tab Bar */}
                    <div className="px-6 pt-4 flex items-center gap-1 overflow-x-auto no-scrollbar">
                        <button
                        ...
                        <button
                            ...
                            className="ml-2 w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 text-slate-400 hover:bg-indigo-50 hover:text-indigo-600 transition-colors"
                            title="Add Topic"
                        >
                            <FaPlus size={10} />
                        </button>
