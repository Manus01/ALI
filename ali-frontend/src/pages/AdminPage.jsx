...
export default function AdminPage() {
    ...
    const fetchLogs = async () => {
        try {
            ...
            const res = await axios.get('http://localhost:8001/api/admin/research/logs', {
    ...
    const handleLinkUser = async () => {
        ...
        try {
            const token = await currentUser.getIdToken();
            await axios.post('http://localhost:8001/api/admin/users/link-metricool',
    ...
    const handleRunJob = async () => {
        ...
        try {
            const token = await currentUser.getIdToken();
            const res = await axios.post('http://localhost:8001/api/admin/jobs/trigger-nightly-log', {},
                { headers: { Authorization: `Bearer ${token}` } }
            );
